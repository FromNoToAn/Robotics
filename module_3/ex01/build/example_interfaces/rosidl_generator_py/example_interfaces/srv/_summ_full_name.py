...
class Metaclass_SummFullName(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'example_interfaces.srv.SummFullName')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from example_interfaces.srv import _summ_full_name
...
class SummFullName(metaclass=Metaclass_SummFullName):
    from example_interfaces.srv._summ_full_name import SummFullName_Request as Request
    from example_interfaces.srv._summ_full_name import SummFullName_Response as Response
