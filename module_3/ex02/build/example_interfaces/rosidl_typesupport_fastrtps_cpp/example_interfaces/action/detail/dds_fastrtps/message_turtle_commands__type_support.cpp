...
#include "example_interfaces/action/detail/message_turtle_commands__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::action::MessageTurtleCommands_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::action::MessageTurtleCommands_Goal & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_interfaces::action::MessageTurtleCommands_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::MessageTurtleCommands_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::action::MessageTurtleCommands_Goal *>(
    untyped_ros_message);
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_Goal)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
cdr_serialize(
  const example_interfaces::action::MessageTurtleCommands_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::action::MessageTurtleCommands_Result & ros_message)
{
  // Member: result
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::MessageTurtleCommands_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::MessageTurtleCommands_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::MessageTurtleCommands_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_Result)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
cdr_serialize(
  const example_interfaces::action::MessageTurtleCommands_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: odom
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::action::MessageTurtleCommands_Feedback & ros_message)
{
  // Member: odom
  cdr >> ros_message.odom;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::MessageTurtleCommands_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::MessageTurtleCommands_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::MessageTurtleCommands_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_Feedback)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_Feedback__handle;
}
...
// functions for example_interfaces::action::MessageTurtleCommands_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
cdr_serialize(
  const example_interfaces::action::MessageTurtleCommands_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::action::MessageTurtleCommands_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_MessageTurtleCommands_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::MessageTurtleCommands_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::MessageTurtleCommands_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::MessageTurtleCommands_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_SendGoal_Request)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
cdr_serialize(
  const example_interfaces::action::MessageTurtleCommands_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::action::MessageTurtleCommands_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::MessageTurtleCommands_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::MessageTurtleCommands_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::MessageTurtleCommands_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_SendGoal_Response)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_SendGoal_Response__handle;
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_SendGoal)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
cdr_serialize(
  const example_interfaces::action::MessageTurtleCommands_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::action::MessageTurtleCommands_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::MessageTurtleCommands_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::MessageTurtleCommands_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::MessageTurtleCommands_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_GetResult_Request)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for example_interfaces::action::MessageTurtleCommands_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
cdr_serialize(
  const example_interfaces::action::MessageTurtleCommands_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::action::MessageTurtleCommands_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_MessageTurtleCommands_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::MessageTurtleCommands_GetResult_Response;
    is_plain =
      (
      offsetof(DataType, result) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::MessageTurtleCommands_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::MessageTurtleCommands_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_GetResult_Response)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_GetResult_Response__handle;
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_GetResult)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_GetResult__handle;
}
...
// functions for example_interfaces::action::MessageTurtleCommands_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_example_interfaces
cdr_serialize(
  const example_interfaces::action::MessageTurtleCommands_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::action::MessageTurtleCommands_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        example_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_MessageTurtleCommands_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces::action::MessageTurtleCommands_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_interfaces::action::MessageTurtleCommands_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_interfaces::action::MessageTurtleCommands_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, action, MessageTurtleCommands_FeedbackMessage)() {
  return &example_interfaces::action::typesupport_fastrtps_cpp::_MessageTurtleCommands_FeedbackMessage__handle;
}
